...
class rescldnn(object):
	...
	l3 = Convolution2D(64, 1, 8, init='glorot_uniform', border_mode='same', activation="relu")(res2)
	do3 = Dropout(0.6)(l3)
	l4 = Convolution2D(64, 1, 8, init='glorot_uniform', border_mode='same', activation="relu")(do3)
	do4 = Dropout(0.6)(l4)
	res2 = merge([res2,l4], mode='sum')
	...
	self.name = "resnet-cldnn-deep"
	self.desc = "7 64 1x8 convolutions with 4 residual, lstm, 2 smaller dense, 0.6 dropout"
	self.ver = "v0"
